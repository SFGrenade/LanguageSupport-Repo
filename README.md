...
The Language Support mod enables the use of additional languages in a similar way CustomKnight does.

This repository is meant to contain community-made translations.
